...
public class Main {
    ...
    protected static ArrayList<Produto> listaProdutos = new ArrayList<Produto>();
            ...
            do {
                ...
                if (escolhaPessoaFisicaMaiuscula.equals("F")) {
                    ...
                    try {
                        ...
                        listaClientes.add(a);
                    } catch (enderecoException | foneException | cnpjException | nomeException a) {
                        System.out.println(a.getMessage());
                        break;
                    } catch (Exception g) {
                        System.out.println("ERRO");
    ...
    public static void menuProdutos(){
        ...
        int opcao;
        System.out.println("===================================================================================\n" +
                "MENU DE PRODUTOS, ESCOLHA UMA OPÇÃO:\n" +
                "(1) CADASTRAR UM NOVO PRODUTO\n" +
                "(2) VISUALIZAR OS PRODUTOS EXISTENTES\n" +
        ...
        if (opcao==1){
            //Sistema de criação do produto
            System.out.println("===================================================================================\n" +
                    "SISTEMA DE CRIAÇÃO DE PRODUTO\n");
            Scanner teclado = new Scanner(System.in);
            try {
                ...
                Produto a = new Produto(descricao,produto,marca,preco,quantidade);
                listaProdutos.add(a);
            }catch (descricaoException | produtoException | marcaException | precoException | quantidadeException a){
                System.out.println(a.getMessage());
            } catch (Exception b){
                System.out.println(b.getMessage());
            }
            ...
            System.out.println("===================================================================================\n");
            System.out.println("Sistema de exlcusão de produtos");

            System.out.println("PRODUTOS DISPONÍVEIS, DIGITE O ID DO QUE DESEJA EXCLUIR\n");
            System.out.println("===================================================================================\n");
            ...
            Scanner teclado = new Scanner(System.in);
            int escolhaId = teclado.nextInt();

            for (Produto i : listaProdutos){
                int idProdutoAtual = i.getIdProduto();

                if (idProdutoAtual == escolhaId){
